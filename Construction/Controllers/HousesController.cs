...
namespace Construction.Controllers
{
    public class HousesController : Controller
    {
        ...
        {
            var houses = db.Houses.Include(h => h.Customer).Include(h => h.Houses1).Include(h => h.House1).Include(h => h.Location).Include(h => h.Type).Include(h => h.Location1).Include(h => h.Type1);
